...
import com.spacece.libforsmall.SendNotification.APIService;
import com.spacece.libforsmall.SendNotification.Client;
import com.spacece.libforsmall.SendNotification.Data;
import com.spacece.libforsmall.SendNotification.MyResponse;
import com.spacece.libforsmall.SendNotification.NotificationSender;
                                                                                                                            ...
                                                                                                                            public void onSuccess(Void aVoid) {
                                                                                                                                ...
                                                                                                                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(ChefId).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                                                    ...
                                                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                                                        ...
                                                                                                                                        ReusableCodeForAll.ShowAlert(getContext(), "", "Your Order has been shifted to Pending state, please wait until the Owner accept your order.");
                                                                                                                                    }
